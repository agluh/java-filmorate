CREATE TABLE IF NOT EXISTS `user` (
    user_id BIGSERIAL AUTO_INCREMENT PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS film (
    film_id BIGSERIAL AUTO_INCREMENT PRIMARY KEY NOT NULL,
    name VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS genre (
    genre_id BIGSERIAL AUTO_INCREMENT PRIMARY KEY NOT NULL,
    name VARCHAR(255) NOT NULL
);
